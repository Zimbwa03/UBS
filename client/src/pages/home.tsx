        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <Card className="rounded-2xl p-8 shadow-lg mb-8">
                <h2 className="text-3xl font-bold mb-6" data-testid="text-about-title">About This Event</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-muted rounded-lg p-4">
                      ...
                      <p className="text-muted-foreground">Guruve, Zimbabwe</p>
                    </div>
                    <div className="bg-muted rounded-lg p-4">
                      <h4 className="font-semibold mb-2 flex items-center">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-3 text-primary">What Your Donation Provides</h3>
